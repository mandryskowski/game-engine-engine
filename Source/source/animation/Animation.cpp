...
Animation::Animation(const std::string& hierarchyTreePath, aiAnimation* anim):
	Localization(hierarchyTreePath, anim->mName.C_Str()), Duration(anim->mDuration / ((anim->mTicksPerSecond != 0.0f) ? (anim->mTicksPerSecond) : (1.0f)))
{
